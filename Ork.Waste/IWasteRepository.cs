...
namespace Ork.Waste
{
  ...
  {
    DataServiceCollection<WasteContainer> Container { get; }
    DataServiceCollection<Disposer> Disposer { get; }
    DataServiceCollection<WasteCollection> WasteCollections { get; }
    IEnumerable<EntityDescriptor> Entities { get; }
    DataServiceCollection<ScheduledTask> FillLevelReadings { get; }
