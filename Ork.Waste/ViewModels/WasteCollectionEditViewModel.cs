...
{
  internal class WasteCollectionEditViewModel : PropertyChangedBase
  {
    private WasteCollection m_Model;
    ...
    public double ActualState
    {
      ...
      set { m_Model.ActualState = value; }
    }

    public double ActualPrice
    {
      get { return m_Model.ActualPrice; }
      set { m_Model.ActualPrice = value; }
    }
  }
}