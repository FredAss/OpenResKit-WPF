...
{
  [Export(typeof (IWasteCollectionContainerViewModelFactory))]
  public class WasteCollectionContainerViewModelFactory : IWasteCollectionContainerViewModelFactory
  {
    private IContainerViewModelFactory m_ContainerViewModelFactory;
