...
namespace Ork.Meter
{
  public interface ITaskGenerator
  {
    ...
    IEnumerable<MeterReading> GenerateMeterReadings(TaskGeneratorConfig taskGeneratorConfig);
    IEnumerable<MeterReading> GenerateMeterReadings(DomainModelService.Meter meter, ResponsibleSubject responsibleSubject, Series series, DayOfWeek[] weekDays);
  }
}